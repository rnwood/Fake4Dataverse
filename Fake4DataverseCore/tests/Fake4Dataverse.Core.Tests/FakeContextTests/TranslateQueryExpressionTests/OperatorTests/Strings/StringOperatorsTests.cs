...
namespace Fake4Dataverse.Tests.FakeContextTests.TranslateQueryExpressionTests.OperatorTests.Strings
{
    public class StringOperatorsTests: Fake4DataverseTests
    {
        [Fact]
