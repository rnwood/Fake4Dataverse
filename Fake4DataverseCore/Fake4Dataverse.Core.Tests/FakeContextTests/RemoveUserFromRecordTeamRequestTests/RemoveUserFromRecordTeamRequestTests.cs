...
namespace Fake4Dataverse.Tests.FakeContextTests.RemoveUserFromRecordTeamRequestTests
{
    public class RemoveUserFromRecordTeamRequestTests: Fake4DataverseTests
    {
        [Fact]
