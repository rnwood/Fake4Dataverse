...
{
    public class ExpandedHandlerTests
    {
        [Fact]
        public void SetStateRequest_UpdatesStatecodeAndStatuscode()
        {
            ...
            var retrieved = service.Retrieve("account", id, new Microsoft.Xrm.Sdk.Query.ColumnSet("statecode", "statuscode"));
        ...
        public void AssignRequest_UpdatesOwnerid()
        {
            ...
            var retrieved = service.Retrieve("account", id, new Microsoft.Xrm.Sdk.Query.ColumnSet("ownerid"));
        ...
        public void ExecuteMultipleRequest_ContinueOnError_False_StopsOnFirstError()
        {
            ...
            {
                new CreateRequest { Target = new Entity("account") { ["name"] = "A" } },
                new CreateRequest { Target = new Entity("account", existingId) { ["name"] = "Dup" } }, // Will fail
                new CreateRequest { Target = new Entity("account") { ["name"] = "C" } }
            };
            ...
            // Should have stopped after the second request (index 1)
        ...
        public void UpsertRequest_CreatesWhenNew()
        {
            ...
            var retrieved = service.Retrieve("account", targetRef.Id, new Microsoft.Xrm.Sdk.Query.ColumnSet("name"));
